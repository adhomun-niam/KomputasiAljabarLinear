...
Eliminasi Gauss adalah metode untuk menyelesaikan sistem persamaan linear
dengan mengubah matriks menjadi bentuk segitiga atas menggunakan Operasi Baris Elementer (OBE).
...
Dari hasil eliminasi Gauss diperoleh:
- $x_1 = 1$
- $x_2 = 2$
- $x_3 = 3$
- $x_4 = 4$
